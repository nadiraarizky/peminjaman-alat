        ...
        <aside class="w-72 bg-white border-r border-pink-100 flex flex-col shadow-2xl shadow-pink-200/50 sticky top-0 h-screen">
            ...
            <nav class="flex-1 px-4 space-y-1 overflow-y-auto custom-scrollbar">
                ...
                <div class="pt-4 mt-6 border-t border-pink-50">
                    ...
                    <x-nav-link-custom :href="route('profile.edit')" :active="request()->routeIs('profile.edit')" icon="M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z">Profil Saya</x-nav-link-custom>
